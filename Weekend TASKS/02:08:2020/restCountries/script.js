...
const ss5 = sss.reduce((currentTotal, item) => {
...
const ss6 = sss.filter((item) => {
    return item.region === "Asia";
});
const ss7 = ss6.reduce((currentTotal, item) => {
    return item.population + currentTotal;
}, 0);
console.log(ss7);
